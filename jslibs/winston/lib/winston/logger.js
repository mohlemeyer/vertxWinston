...
var events = require('jslibs/winston/thirdPartyDeps/eventemitter2/eventemitter2'),
    ...
    async = require('jslibs/winston/thirdPartyDeps/async/async'),
...
Logger.prototype.stream = function (options) {
  ...
  transports.forEach(function (transport) {
    ...
    stream.on('log', function (log) {
      // Rhino won't allow me to modify the function argument here
...
Logger.prototype.handleExceptions = function () {
    throw new Error('handleExceptions not supported on vertx/Rhino');
...
Logger.prototype.unhandleExceptions = function () {
    throw new Error('unhandleExceptions not supported on vertx/Rhino');
  var self = this;
