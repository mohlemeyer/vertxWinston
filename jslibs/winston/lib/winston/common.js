...
var jsDump = require('jslibs/winston/thirdPartyDeps/jsDump/jsDump'),
    sha1 = require('jslibs/winston/thirdPartyDeps/crypto/sha1'),
    cycle = require('jslibs/winston/thirdPartyDeps/cycle/cycle'),
...
exports.clone = function (obj) {
  ...
  for (var i in obj) {
    ...
    else if (obj[i] instanceof vertx.Buffer) {
        copy[i] = obj[i];
    }
...
exports.log = function (options) {
  ...
  if (options.json) {
    ...
    return JSON.stringify(output, function (key, value) {
      return value instanceof vertx.Buffer
...
exports.serialize = function (obj, key) {
  ...
  if (obj instanceof vertx.Buffer) {
    return key ? key + '=' + DatatypeConverter.printBase64Binary(obj.getBytes()) :
        DatatypeConverter.printBase64Binary(buff.getBytes()) + '';
  }
